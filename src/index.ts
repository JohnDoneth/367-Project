...
class MazeGame {
  ...
  constructor() {
    ...
    document
      .getElementById("ballTrailButton")
      .addEventListener("click", () => {
        this._ballTrail = !this._ballTrail;
        if (this._ballTrail) 
          document.getElementById("ballTrailButton").innerHTML = "Shaders enabled";
        else 
          document
            .getElementById("ballTrailButton")
            .innerHTML = "Shaders disabled";
        }
      );
    document
    ...
    document
      .getElementById("playButtonNight")
      .addEventListener("click", () => {
        document
          .getElementById("start-screen")
          .style
